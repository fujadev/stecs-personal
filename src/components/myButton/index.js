...
//     const { className, children, primaryButton, ...otherProps } = props;
...
const MyButton = (props) => {
    ...
    if (props.href) {
        return (
            <a className={`${classes.myButton} ${primaryButton ? classes.primaryButton : classes.secondaryButton}`} {...otherProps}>
                {children} {/* Render children as the content of the anchor */}
            </a>
        );
    }
    ...
    if (isSignUpButton) {
        ...
        return (
            <button className={`${classes.myButton} ${primaryButton ? classes.primaryButton : classes.secondaryButton} ${className}`} type="button" {...otherProps}>
                {children} {/* Render children as the content of the button */}
            </button>
        );
    }
