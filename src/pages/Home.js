  ...
  return (
    <>
      ...
      >
        ...
        <img src="./images/hero/cash1.png" alt="" className={classes.image2} />
        <img src="./images/hero/cash2.png" alt="" className={classes.image3} />
        ...
        <div className={classes.insight}>
          <div className={classes.texts}>
            ...
            <p className={classes.small}>
              ...
              spending habits. With powerful tools to analyze your spending, you
              can track your progress, make adjustments, and stay on top of your
              budget with ease.
            </p>
          </div>
        ...
        <div className={classes.accordion}>
          <div class="accordion" id="accordionExample">
            <div class={`${classes.item} accordion-item`}>
              <h2 class={`${classes.header} accordion-header`} id="headingOne">
                <button
            ...
            <div class={`${classes.item} accordion-item`}>
              <h2 class={`${classes.header} accordion-header`} id="headingTwo">
                <button
                  class="accordion-button collapsed"
                  type="button"
                  data-bs-toggle="collapse"
                ...
                >
                  How does STECS protect my personal and financial information?
                </button>
              </h2>
              <div
                id="collapseTwo"
              ...
              >
                <div class="accordion-body">
                  We take your financial security seriously and have implemented
                  rigorous measures to safeguard your funds. From advanced
                  encryption to fraud detection and prevention, we have your
                  back every step of the way. Rely on bank-grade security with
                  all your monies fully insured by NDIC.
                </div>
              </div>
            </div>
            <div class={`${classes.item} accordion-item`}>
              ...
              >
                <div class="accordion-body">
                  ...
                  many different faiths and beliefs. It means that the financial
                  institution or platform, such as Stecs, operates with a sense
                  of responsibility towards the environment and society, in
                  addition to providing financial benefits to its users. This
                  can include promoting fair trade, investing in renewable
                  energy, avoiding investments in harmful industries, and
      ...
      >
        <div className={classes.texts}>
          ...
          <p className={classes.small}>
            Expertly curated articles to help you understand how our application
            works.
          </p>
        </div>
      ...
      >
        ...
        <div className={classes.card}>
          <div className={classes.details}>
            ...
            <p className={classes.smallText}>
              Get update from us from time to time and be the first to know when
